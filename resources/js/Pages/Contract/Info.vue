...
<template>
    ...
    <AppLayout title="Info">
        ...
        <div class="">
            <Attachment title="Doc. Original"></Attachment>
            <Attachment title="Ficha Tecnica"></Attachment>
            <Attachment title="Suplemento"></Attachment>
            <Attachment title="Actualizacion"></Attachment>
            <Attachment title="Suplemento"></Attachment>
            <Attachment title="Suplemento"></Attachment>
            <Attachment title="Suplemento"></Attachment>
            <Attachment title="Suplemento"></Attachment>
