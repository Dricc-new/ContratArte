...
<template>
    <AppLayout title="Busqueda">
        <Search :link="route('Data.list')" :text="search"></Search>
        <div class="flex justify-center table-list">
             <table class="w-full text-xl text-zinc-200 ">
                ...
                <tbody class="m-2">
                    <tr v-for="company in Datas.data" class="text-lg">
                        ...
                        <td class="border-b p-1 border-zinc-300 w-8"><div class="flex justify-center"><Link :href="route('Data.info',{id: company.id})"><button class="fa h-8 w-8 rounded fa-info-circle fa-lg font-bold text-zinc-200"></button></Link></div></td>
                    </tr>
                </tbody>
        </table>
    </div>
    <Pagination :links="Datas.links" :total="Datas.total"></Pagination>
</AppLayout>
</template>
